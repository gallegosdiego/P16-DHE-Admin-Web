...
const navItems = [
  {
    href: "/",
    label: "Dashboard",
    icon: "M4 13h7V4H4v9Zm9 7h7V4h-7v16ZM4 20h7v-5H4v5Z",
  },
  {
    href: "/pedidos",
    label: "Pedidos",
    icon: "m3.5 7 8.5-4 8.5 4-8.5 4-8.5-4ZM3.5 7v10l8.5 4 8.5-4V7",
  },
  {
    href: "/clientes",
    label: "Clientes",
    icon: "M4 19h16M6 17V9l6-4 6 4v8",
  },
  {
    href: "/conductores",
    label: "Conductores",
    icon: "M5.5 17H4l2.4-6.5h5.4l1.6 6.5M13 10.5h3.5l2.2 6.5M8 17a2.5 2.5 0 1 1 0-.01M18 17a2.5 2.5 0 1 1 0-.01",
  },
  {
    href: "/novedades",
    label: "Novedades",
    icon: "M12 3 22 20H2L12 3ZM12 9v5M12 17h.01",
  },
  {
    href: "/pagos",
    label: "Pagos",
    icon: "M12 6v12M15.5 8.8c-.8-.7-1.9-1-3.2-1-1.8 0-3 .8-3 2.1 0 3.4 6.5 1.6 6.5 5.1 0 1.4-1.3 2.2-3.3 2.2-1.5 0-2.9-.5-3.8-1.3M3 12a9 9 0 1 0 18 0 9 9 0 0 0-18 0Z",
  },
  {
    href: "/reportes",
    label: "Reportes",
    icon: "M4 19V5M4 19h17M8 16v-4M13 16V8M18 16v-6",
  },
  {
    href: "/configuracion",
    label: "Configuracion",
    icon: "M12 15a3 3 0 1 0 0-6 3 3 0 0 0 0 6ZM19.4 15a8.2 8.2 0 0 0 .1-1l2-1.5-2-3.5-2.4 1a8 8 0 0 0-1.7-1l-.3-2.6h-4l-.3 2.6a8 8 0 0 0-1.7 1l-2.4-1-2 3.5 2 1.5a8.2 8.2 0 0 0 .1 2.1l-2 1.5 2 3.5 2.4-1c.5.4 1.1.7 1.7 1l.3 2.6h4l.3-2.6c.6-.3 1.2-.6 1.7-1l2.4 1 2-3.5-2.2-1.6Z",
  },
];
          ...
          <div className="flex items-center gap-2">
            ...
            <div className="relative">
              <button
                ...
                className="relative rounded-lg border border-slate-200 p-2 text-slate-600 transition-colors duration-150 hover:bg-slate-100"
            ...
            <button
              ...
              className="rounded-lg border border-slate-300 px-3 py-1.5 text-xs font-semibold text-slate-700 transition-colors duration-150 hover:bg-slate-100"
            >
              Salir
            </button>
          </div>
