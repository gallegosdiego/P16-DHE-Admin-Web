...
class AuthTest extends TestCase
{
    ...
    public function test_deploy_check_exposes_geodata_runtime_status(): void
    {
        ...
        $response->assertOk()
            ...
            ->assertJsonPath('database.operational_intake_columns.idempotency_records.idempotency_key', true)
            ->assertJsonPath('database.operational_intake_columns.pickup_batches.delivered_by_name', true)
